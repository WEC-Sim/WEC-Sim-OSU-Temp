...
% Create piecewise dynamic systems for each regime 
% This is the model for a rectified flow, Torque Control, and reactive power pump control
%
% Notes:
...
namePTO = 'PTO_150kW_Hs3_Ts10_PassiveSystem';
...
[con wec pto] = loadSimParameters_PassiveSystem(savePath, namePTO);

subVars = [Ct b_e V0 pC0 pD0 vC0 vD0 D bg J m A B K Cd Ap rho k1 Rt Dh v av1 av2 av3 k2 bf];  
subVals = [pto.Ct pto.b_e pto.V0 pto.pC0 pto.pD0 pto.vC0 pto.vD0 pto.D pto.bg pto.J wec.m wec.A wec.B wec.K pto.Cd pto.Ap pto.rho pto.k1 pto.Rt pto.Dh pto.v pto.av1 pto.av2 pto.av3 pto.k2 pto.bf];
...
%% Save and Exit
save([savePath 'dynModel_PassiveSystem'], 'dynModel')
