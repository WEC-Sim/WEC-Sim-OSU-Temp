...
%NOTE (Kelley): Is this meant to be here? It doesn't seem to fit...
...
%Note (Kelley): removed because this is misleading due to the energy storage of the accumulators

%The hydraulic PTO system efficiency ($Pnorm_{abs}$ to $Pnorm_{elec}$) is 60\%. The efficiency of the mechanical to electrical conversion stage is 82\%. 
