...
classdef simulationClass<handle 
    ...
    properties (Access = public) 
        ...
        mode                = 'rapid-accelerator'                                     %'normal','accelerator','rapid-accelerator' (default = 'normal') 
    ...
    methods
        ...
        % Loads the model and sets the simulation parameters   % 'AccelVerboseBuild',obj.verbose,...
            load_system(fName);
